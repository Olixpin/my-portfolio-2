...
const BlogUI = ({ id, title, subtitle, date, category }) => {
  return (
    <>
      <div
        className=" grid gap-[3.2rem] px-32 pr-16 max-[1033px]:px-16 py-5 max-[800px]:px-10 max-[800px]:flex flex-col bg-textWhite dark:bg-backgroundDark  rounded-2xl hover:shadow-2xl transition-all duration-500 ease-in-out border border-dashed border-grey200 max-[425px]:border-none max-[425px]:p-16 max-[425px]:px-8"
        style={{
...
const BlogH = () => {
  return (
    <section
      id="blog"
      className="py-32  dark:bg-backgroundDark2 max-[800px]:py-16 "
    >
      <ComponentLayoutSize>
        <div className="flex flex-col  justify-center gap-16 max-[800px]">
          <h1 className="text-6xl font-medium max-[1028px]:text-4xl dark:text-grey100  max-[425px]:text-3xl">
            My Blog
          </h1>
          <div
            className=" grid gap-16 px-8 max-[1033px]:px-0 py-5 max-[800px]:px-2 max-[800px]:flex flex-col max-[800px]:-mt-8 max-[400px]:mt-0"
            style={{
          ...
          >
            ...
            <div className="middle bg-grey800 dark:bg-background w-[.5px] text-center max-[800px]:hidden"></div>
            <div className="right py-8 flex flex-col gap-16 max-[800px]:-mt-16 !max-[400px]:mt-0">
